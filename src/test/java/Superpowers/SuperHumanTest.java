...
public class SuperHumanTest {
    ...
    public void getIDTest(){
        ...
        Assert.assertEquals(expected, superHuman.getId());
    }
    @Test
    public void getDOBTest(){
        ...
        Assert.assertEquals(expected, superHuman.getDob());
    }
    @Test
    public void getGenderTest(){
        ...
        Assert.assertEquals(expected, superHuman.getGender());
    }
    @Test
    public void getOccupationTest(){
        ...
        Assert.assertEquals(expected, superHuman.getOccupation());
    }
    @Test
